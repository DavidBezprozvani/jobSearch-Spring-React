...
VALUES (1, 'Senior AWS Engineer', 'REMOTE',
       ...
       (2, 'Mid/Senior Data Engineer', 'FULL_TIME',
        'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''''s standard dummy text ever since the 1500s, when',
        'Looking for an individual who is passionate about learning new things and solving problems. ',
        CURRENT_TIMESTAMP(), 'Kaunas','#', 1),
       (3, 'Junior Implementation Developer', 'PART_TIME',
        'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''''s standard dummy text ever since the 1500s, when',
        'Looking for an individual who is passionate about learning new things and solving problems. ',
        CURRENT_TIMESTAMP(),
        'Vilnius','#', 2),
       (4, 'Senior full-stack developer', 'FULL_TIME',
        'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''''s standard dummy text ever since the 1500s, when',
        'Looking for an individual who is passionate about learning new things and solving problems. ',
        CURRENT_TIMESTAMP(),
        'Vilnius', '#', 3),
       (5, 'Senior Backend Engineer', 'INTERNSHIP',
        ...
        CURRENT_TIMESTAMP(),
        'Klaipėda', '#', 4),
       (6, 'Mid Node.js Developer', 'FULL_TIME',
        'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''''s standard dummy text ever since the 1500s, when',
        'Looking for an individual who is passionate about learning new things and solving problems. ',
        CURRENT_TIMESTAMP(),
        'Vilnius', '#', 5),
       (7, 'Mid Node.js Developer', 'FULL_TIME',
        'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''''s standard dummy text ever since the 1500s, when',
        'Looking for an individual who is passionate about learning new things and solving problems. ',
        CURRENT_TIMESTAMP(),
        'Vilnius', '#', 5),
       (8, 'Mid Node.js Developer', 'FULL_TIME',
        'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''''s standard dummy text ever since the 1500s, when',
        'Looking for an individual who is passionate about learning new things and solving problems. ',
        CURRENT_TIMESTAMP(),
        'Vilnius', '#', 5),
       (9, 'Mid Node.js Developer', 'INTERNSHIP',
        'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''''s standard dummy text ever since the 1500s, when',
        'Looking for an individual who is passionate about learning new things and solving problems. ',
        CURRENT_TIMESTAMP(),
        'Vilnius', '#', 5);
